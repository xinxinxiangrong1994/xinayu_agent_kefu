...
CREATE TABLE `products` (
  ...
  `title` varchar(100) DEFAULT NULL COMMENT '商品标题（描述前15字）',
  `price` varchar(20) DEFAULT NULL COMMENT '商品价格',
  `description` text COMMENT '完整商品描述',
...
INSERT INTO `products` VALUES ('1012259474092','Wacom PTH660 专业数位板 | 准新级品质 | 顺','3998',NULL,'这是全球限量版的，如何用户执意要优惠，则可以告知500快钱加','2026-01-13 23:10:20','2026-01-14 00:11:17');
...
CREATE TABLE `user_sessions` (
  ...
  `product_title` varchar(100) DEFAULT NULL COMMENT '商品标题（前15字）',
...
-- Dump completed on 2026-01-17 18:19:48
